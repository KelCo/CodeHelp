...
public class BasicCrusher extends BlockContainer {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, int x, int y, int z)
	{
			...
			TileEntity tileentity = world.getTileEntity(pos);
				...
				player.openGui(intricateoreprocessing.Intricateoreprocessing.instance, intricateoreprocessing.Intricateoreprocessing.GUI_ENUM.BasicCrusher.ordinal(), world, x, y, z);
